...
//        int[] path = temp11.pathFromTo();
        ...
        VertexConnection vertexConnection3 = new VertexConnection();
        ...
        vertexConnection.addVertex(testPeople11, new Connection((byte) 70, 26));
        People testPeople12 = new People(55.7256, 37.5744, 12, "test3", "test3");
        vertexConnection.addVertex(testPeople12, new Connection((byte) 50, 27));
        vertexConnection1.addVertex(testPeople11, new Connection((byte) 100, 28));
        People testPeople13 = new People(55.7859, 37.6698, 13, "test4", "test4");
        vertexConnection1.addVertex(testPeople13, new Connection((byte) 10, 29));
        vertexConnection2.addVertex(testPeople12, new Connection((byte) 100, 30));
        vertexConnection2.addVertex(testPeople11, new Connection((byte) 90, 31));
        vertexConnection2.addVertex(testPeople13, new Connection((byte) 50, 32));
        People testPeople14 = new People(55.7337, 37.6719, 14, "test5", "test5");
        vertexConnection2.addVertex(testPeople14, new Connection((byte) 40, 33));
        vertexConnection3.addVertex(testPeople13, new Connection((byte) 100, 34));
        People testPeople15 = new People(55.7608, 37.8231, 15, "test6", "test6");
        vertexConnection3.addVertex(testPeople15, new Connection((byte) 30, 35));
        vertexConnection4.addVertex(testPeople14, new Connection((byte) 100, 36));
        vertexConnection4.addVertex(testPeople15, new Connection((byte) 30, 37));
        vertexConnection5.addVertex(testPeople15, new Connection((byte) 100, 38));
...
//        vertexConnection1.addVertex(ttt, testC11);
        ...
        VertexConnection vertexConnection6 = new VertexConnection();
        People testPeople16 = new People(1, 2, 44, "test7", "test7");
        vertexConnection6.addVertex(testPeople16, new Connection((byte) 100, 39));
        test123.getConnectionOfVertex().add(vertexConnection6);
        test123.setAmountOfVertex(test123.getAmountOfVertex() + 1);
        Dijkstra dijkstra = new Dijkstra(test123, testPeople16, testPeople10);
        int[] test156 = dijkstra.pathFromTo();
